...
class RuntimeCapabilities(_message.Message):
    __slots__ = ("memory_snapshot", "disk_snapshot", "live_checkpoint", "guest_agent", "hardware_isolation", "lazy_restore", "cow_fork", "egress_control")
...
class Operation(_message.Message):
    __slots__ = ("op_id", "kind", "instance_id", "state", "current_step", "error", "degraded", "created_at", "finished_at", "froze_workload")
